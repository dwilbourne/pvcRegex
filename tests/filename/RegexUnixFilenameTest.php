...
use pvc\regex\filename\RegexUnixFilename;

class RegexUnixFilenameTest extends TestCase
{
    protected RegexUnixFilename $regexUnixFilename;

    public function setUp(): void
    {
        $this->regexUnixFilename = new RegexUnixFilename();
    }
